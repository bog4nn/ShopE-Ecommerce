...
import com.shope.admin.brand.BrandService;
...
public class ProductController {
	...
	public String saveProduct(Product product , RedirectAttributes ra,
			...
			@RequestParam(value = "extraImage",required = false)MultipartFile[] extraMultiparts,
			@RequestParam(name= "detailIDs", required = false)String[] detailIDs,
			@RequestParam(name = "detailNames",required = false)String[] detailNames,
			@RequestParam(name = "detailValues",required = false)String[] detailValues,
			@RequestParam(name = "imageIDs", required = false)String [] imageIDs,
			@RequestParam(name = "imageNames", required = false)String[] imageNames,
			@AuthenticationPrincipal ShopEUserDetails loggedUser
			) throws IOException {
			...
			ProductSaveHelper.setMainImageName(mainImageMultipart,product); // main image
			ProductSaveHelper.setExistingExtraImageNames(imageIDs,imageNames,product); // extra
			ProductSaveHelper.setNewExtraImageNames(extraMultiparts,product); // change image
			ProductSaveHelper.setProductDetails(detailIDs,detailNames,detailValues,product);
			
			Product savedProduct = service.save(product);
			// save on DB
			ProductSaveHelper.saveUploadedImage(mainImageMultipart,extraMultiparts,savedProduct);
			
			//if extra Image become orphan then delete 
	...
	public String deleteProduct(@PathVariable("id")Integer id,
		...
		try {
			service.delete(id);
			String productExtraImagesDir = "../product-images/" + id + "/extra";
