...
public class ProductRepositoryTests {
	...
	public void testCreateProduct() {
		Brand brand = entityManager.find(Brand.class, 36);
		Category category = entityManager.find(Category.class, 6);
		
		Product product = new Product();
		product.setName("Acer Aspire Desktop");
		product.setAlias("acer_aspire_desk");
		product.setShortDescription("Short description for Dell Inspriron 3000");
		product.setFullDescription("Full description for Dell Inspriron 3000");
	...
	public void testListAllProducts() {
		Iterable<Product> iterablePruduct = repo.findAll();
		
		iterablePruduct.forEach(System.out::println);
	}
